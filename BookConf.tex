% Pilot conversion from the conference-book PDF (pp. 9--14).
% Editorial notes on uncertain/corrected source notation are provided in
% conversion_notes.txt. Compile with LuaLaTeX.
...
\newcommand{\avg}[2][]{\left\langle #2\right\rangle_{#1}}
...
\begin{center}
{\Large\bfseries A Hybrid Approach to Calibrating a Multiscale Constitutive Model\par}
\vspace{0.8em}
{\large\bfseries V. Yu. Marina\par}
\vspace{0.35em}
{Technical University of Moldova, Chi\c{s}in\u{a}u, Moldova\par}
\href{mailto:vasilemarina21@yahoo.com}{vasilemarina21@yahoo.com}
\end{center}
...
\begin{equation}
 ...
 \sum_k\left[
  2\left(\frac{(B+2G)A_k}{2C_k+A_kB}\right)^2
 +3\left(\frac{B+2G}{2C_k+B}\right)^2-5
 \right]c_k
 =\Extr,
\end{equation}
\begin{equation}
